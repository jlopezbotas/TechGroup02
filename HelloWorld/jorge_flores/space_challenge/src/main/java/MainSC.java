...
public class MainSC {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        File phase1 = new File(new File("src\\main\\resources\\phase-1.txt").getAbsolutePath());
        File phase2 = new File(new File("src\\main\\resources\\phase-2.txt").getAbsolutePath());
